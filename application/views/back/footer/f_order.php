<!-- ================== BEGIN BASE JS ================== -->
	...
	<!-- ================== BEGIN PAGE LEVEL JS ================== -->
	<script src="<?php echo base_url(); ?>assets/back/plugins/DataTables-1.10.2/js/jquery.dataTables.js"></script>
	<script src="<?php echo base_url(); ?>assets/back/plugins/DataTables-1.10.2/js/data-table.js"></script>
