		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="active"><a href="calendar.html"><i class="fa fa-line-chart active"></i> <span>Dashboard</span></a></li>
					
					<li><a href="calendar.html"><i class="fa fa-inbox  active"></i> <span>Message</span></a></li>
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
						    ...
						    <li class="active"><a href="index_v2.html">Kategori</a></li>
