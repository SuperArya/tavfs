		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="active"><a href="<?php echo base_url(); ?>tavfs/dashboard"><i class="fa fa-line-chart active"></i> <span>Dashboard</span></a></li>
					
					<li><a href="<?php echo base_url(); ?>tavfs/message"><i class="fa fa-inbox  active"></i> <span>Message</span></a></li>
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
						    ...
						    <li class="active"><a href="index_v2.html">Bahan</a></li>
