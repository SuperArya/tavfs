		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
                ...
                <li><a href="<?php echo base_url(); ?>index.php/backend/layanan">Tabel Layanan</a></li>
				<li class="active">Tambah Layanan</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Tambah Layanan Arion</h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Tambah Layanan Arion</h4>
                        </div>
