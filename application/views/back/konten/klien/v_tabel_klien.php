		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">Tabel Klien</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Klien Arion</h1>
			<!-- end page-header -->
			    ...
			    <div class="panel-heading">
                    <div class="btn-group pull-right">
                        <a class="btn btn-success btn-xs" 
                           href="<?php echo base_url(); ?>index.php/backend/klien/tambah"> 
                             <i class="fa fa-pencil"></i> Tambah Data Baru
                        </a>  
                    </div>
			        <h4 class="panel-title">Klien Arion</h4>
			    </div>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-xs" 
                                                   href="<?php echo base_url(); ?>index.php/backend/Klien/ubah"><i class="fa fa-edit (alias)"></i> ubah</a>
                                                &nbsp; 
